...
- [x] [Review][Patch] Worker log check asks operators to find a staged-file signal the worker does not log [docs/manual-testing.md:1607] — fixed by using connector IDs plus `cos docs --json` as the drain signal
